            ...
            <?php foreach ($portfolio as $port) : ?>
              <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <div class="portfolio-wrap">
                  <img src="<?= base_url(); ?>/assets/img/portfolio/<?= $port['gambar']; ?>" class="img-fluid" alt="">
                  <div class="portfolio-info">
                    <div class="portfolio-links">

                      <a href="<?= base_url(); ?>/assets/img/portfolio/<?= $port['gambar']; ?>" data-galerylery="portfoliogalerylery" class="portfolio-lightbox" title="<?= $port['judul']; ?>"><i class="bx bx-expand-alt"></i></a>
